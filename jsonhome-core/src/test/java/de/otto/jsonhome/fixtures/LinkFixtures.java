...
public class LinkFixtures {
    ...
    public static final DirectLink PAGES_LINK_WITH_RELATIVE_HREF = directLink(RESOURCELINK_SHOP_PAGES, REL_PAGES_HREF, new Hints(of(GET), asList("text/html", "application/json")));
